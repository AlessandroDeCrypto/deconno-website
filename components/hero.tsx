  ...
  return (
    <section className="relative overflow-hidden bg-neutral-950 text-white">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-24 md:px-8 lg:grid-cols-2 lg:items-center lg:py-32">
        ...
        <div className="relative z-10">
          <div className="aspect-[4/3] rounded-[2rem] border border-white/10 bg-white/5 shadow-2xl backdrop-blur-sm flex items-center justify-center text-sm text-neutral-400">
